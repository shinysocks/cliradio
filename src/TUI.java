public class TUI {
    ...
    public static String hostChatStart() {
        return Color.gray("   _____________________________________________________________\n Ctrl+c to quit, select microphone or internal capture in settings");
    }
    
    public static String clientChatStart() {
        return Color.gray("   ____________________________________________________\n Ctrl+c to quit, select speaker or headphones in settings");
    }
    
    public static class Color {
        public final static String DEFAULT = IS_WINDOWS ? "Esc[0m": "\u001b[0m";
        private final static String BOLD_RED = IS_WINDOWS ? "Esc[91m": "\u001b[31;1m";
        private final static String BOLD_BLUE = IS_WINDOWS ? "Esc[94m": "\u001b[34;1m";
        private final static String BOLD_GREEN = IS_WINDOWS ? "Esc[92m": "\u001b[32;1m";
        private final static String BOLD_YELLOW = IS_WINDOWS ? "Esc[93m": "\u001b[33;1m";
        private final static String BOLD_MAGENTA = IS_WINDOWS ? "Esc[95m": "\u001b[35;1m";
        private final static String BOLD_CYAN = IS_WINDOWS ? "Esc[96m": "\u001b[36;1m";
        private final static String BOLD_GRAY = IS_WINDOWS ? "Esc[90m": "\u001b[90;1m";
